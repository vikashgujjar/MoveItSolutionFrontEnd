...
const LogisticsLeft = () => {
  ...
  const items = [
    {
      id: 1,
      name: "Logistics service for commercial goods",
    ...
    { id: 6, name: "Supply Chain", href: "/supply-chain" },
    { id: 7, name: "Heavy Goods Transport", href: "/heavy-goods-transport" },
  ];
